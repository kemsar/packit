...
function messageUser(user, originalUsername, messageTemplate) {
    return new Promise((resolve, reject) => {
        ...
        const mailOptions = {
            from: 'LighterPack <info@mg.packit.com>',
            to: user.email,
            "h:Reply-To": "LighterPack <info@packit.com>",
